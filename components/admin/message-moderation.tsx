...
import { Search, Trash2, RefreshCw, MessageSquare, User } from "lucide-react"
...
const handleNukeAllMessages = async () => {
  if (!window.confirm("CRITICAL WARNING: This will delete ALL messages, groups, and chat history for EVERYONE. This action cannot be undone. Are you absolutely sure?")) {
    return
  }
